...
<div class="row">
   <div class="card shadow">
      <div class="card-header">
         ...
         <?php endif;?>
         <h4 class="fw-bold">Manage <span class="fst-italic text-primary">Teachers</span></h4>
         <hr>
      </div>
      <div class="card-body">
         <div class="card py-3 px-3">
            <div class="row">
               <div class="card-title">
                  ...
                  <?php endif; ?>
                  <h5 class="fw-bold text-primary">Create Teacher</h5>
               </div>
               <div class="card-body">
                     ...
                     <div class="col-12 col-xl-8 col-md-12 col-sm-12">
                        ...
                        <div class="d-flex flex-wrap align-content-center mb-3">
                           ...
                           <div class="flex-sm-fill flex-fill mx-1 mb-3" style="width: 180px;">
                              ...
                              <br>
                              <select name="masterclass" id="class_section" class="form-select <?php if(form_error('masterclass')) echo 'is-invalid';?>">
                                 <option value=""></option>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-6">
                     ...
                     <ul class="text-secondary">
                        <li>SCHOOL ID: <?= $teacher->userID ?></li>
                        <li>First name: <?=$teacher->fname?></li>
                        <li>Middle name: <?=$teacher->mname?></li>
                        <li>Last name: <?=$teacher->lname?></li>
                     </ul>
                     <div class="p-3">
                        <a href="<?=base_url('View_teacher/'.$teacher->userID)?>" class="btn btn-primary">View</a>
                        <a href="<?=base_url('Edit_teacher/'.$teacher->userID)?>" class="btn btn-success">Edit</a>
                        <a href="<?=base_url('Delete_teacher/'.$teacher->userID)?>" class="btn btn-danger">Delete</a>
                     </div>
                  </div>
                  <div class="col-2">
                     <a href="<?=base_url('Admin/manage_dataset/'.$teacher->userID)?>" class="btn btn-primary">Face Dataset &raquo</a>
                  </div>
               </div>
            </div>
            <?php endforeach; ?>
